...
class StudentExtraController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        {
            $students = $students->join('classes', 'students_extra.current_class_id', '=', 'classes.id')
        ...
        return view('students_extra.index', compact(
            'title',
            'students',
            'levels',
            'limit_per_page'
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('student_extra.index')->with('success', 'Student has been added successfully');
    }
    ...
    public function show(Student $student)
    {
        ...
        return view('students_extra.show', compact(
            'title', 
            'return_route',
            'student',
            'student_classes'
    ...
    public function ajax_show(Request $request)
    {
        if($request->ajax())
        {
            ...
            return view('students_extra.show_ajax', compact(
                'title', 
                'return_route',
                'student',
                'student_classes',
    ...
    public function edit($id)
    {
        ...
        return view('students_extra.edit', compact(
            'title', 
            'return_route',
            'student',
            'current_level_id',
    ...
    public function destroy(Student $student, Request $request)
    {
        ...
        if(!empty($request->return_location))
            ...
            return redirect()->route('student_extra.index')->with('success', 'Student <b>'.$stu_name.'</b> has been deleted successfully');
    }
